...
- Long cafeteria payment queues
- Slow inter-student transfers
- Expensive transaction fees
- Manual society contribution tracking

## 💡 Solution

UniCryptoPay provides:
- Instant peer-to-peer payments
- QR code scanning for campus vendors
- Secure digital wallets
- University-controlled private token system
...
Agile + Incremental Model with DevOps practices for CI/CD.

## 📂 Documentation

Full proposal and development plan available in `/docs`.

## 🎯 Goal

To reduce campus payment delays by 70% and modernize university financial systems using blockchain technology.

---

Developed as a university computing project.
